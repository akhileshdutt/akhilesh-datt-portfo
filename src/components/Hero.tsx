...
const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-screen w-full flex flex-col justify-center items-center pt-20 pb-10 px-6 relative">
      <div 
        ref={sectionRef}
        className="container mx-auto flex flex-col lg:flex-row items-center justify-between gap-12 animate-on-scroll"
      >
        ...
        <div className="w-full lg:w-2/5 flex flex-col items-center lg:items-start">
          <div className="relative mb-8">
            ...
            <div className="absolute -bottom-2 -right-2 w-12 h-12 rounded-full bg-cyber-blue flex items-center justify-center animate-pulse">
        ...
        <div className="w-full lg:w-3/5 text-center lg:text-left">
          ...
          <p className="text-lg md:text-xl text-foreground/80 mb-6 max-w-2xl">
            A passionate <span className="text-cyber-blue">cybersecurity expert</span> and 
          ...
          <div className="flex flex-wrap gap-3 justify-center lg:justify-start mb-8">
            <span className="px-3 py-1 text-sm glass-card text-cyber-blue">
              Cybersecurity
            </span>
